...
function createNodeTask(task) {
    ...
    nodeButtonEdit.setAttribute('class', 'btn btn-dark rounded-0') //
    ...
    nodeBtnDelete.setAttribute('class', 'btn btn-dark rounded-0')
    ...
    nodeBtnComplete.setAttribute('class', 'btn btn-dark rounded-0')
